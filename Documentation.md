...
## Member: Hadeel  Al Kassem

### 1-Feature

Setting up a secure websocket that connects  a client and a provider and make them able to chat in a securized, efficient way . 
