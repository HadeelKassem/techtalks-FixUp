    ...
    <Routes>
      {user.role === "CLIENT" && (
        <>
          ...
          <Route
            ...
            element={<LiveLocationPage role="CLIENT" />}
          />
      ...
      {user.role === "PROVIDER" && (
        <>
          <Route
            path="/provider"
            element={<ProviderDashboard user={user} onLogout={handleLogout} />}
          />

          <Route path="/provider/chat" element={<ChatPage role="PROVIDER" />} />

          <Route
            path="/provider/live-location"
            element={<LiveLocationPage role="PROVIDER" />}
          />

          <Route
            path="/provider/profile"
            element={<ProviderProfile user={user} />}
          />
